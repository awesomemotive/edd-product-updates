...
eddPupRemoveMenus();$('#cboxContent .closebutton').live('click',function(){$.fn.colorbox.close();});$('#bundle_filters').click(function(){if($(this).data('state')=='hidden'){$(this).text(eddPup.bf2).data('state','visible');}else{$(this).text(eddPup.bf1).data('state','hidden');}
$('.bundle-filters-wrap').toggle();return false;});if($('#edd-pup-queue-details').length){$('#edd-pup-view-queue-alert').colorbox({inline:true,href:$('#edd-pup-queue-details'),width:'95%',maxWidth:'680px',height:'auto'});}
